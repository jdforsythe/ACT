/**
 * Runtime contract validator. Catches CMS-driven prop drift at register
 * time and routes to PRD-303-R16's placeholder path. Mirrors the React
 * binding's `validate-contract.ts` shape (PRD-301 Open Question 1).
 *
 ...
 * converts a non-null reason to a placeholder per PRD-303-R16.
 */
 ...
 * non-throwing form so failures route to placeholder per PRD-303-R16.
 */
