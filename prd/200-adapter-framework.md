...
4. **Result MUST satisfy PRD-100-R21.** After merge, the resulting node MUST be a fully-formed Node envelope. If any required field is still missing after all contributors have run, the framework MUST raise a build error citing the missing field and the contributing adapters.
