...
| PRD-404 | Docusaurus plugin | Accepted | Implemented (@act-spec/docusaurus) | 400, 301 | 701 | M | P2 |
...
| PRD-409 | Standalone CLI (no framework) | Accepted | Implemented (@act-spec/cli) | 400 | 706 | M | P2 |
...
| PRD-706 | Hybrid static + runtime + MCP bridge | Accepted | Implemented (examples/706-hybrid-static-runtime-mcp) | 409, 501, 602, 600 | — | XL | P3 |
